...
export const ButtonComponentTypeSchema = yup
  .string<ButtonComponentType>()
  .oneOf(Object.values(ButtonComponentType))
  .defined();

export const EventOptionTypeSchema = yup
  .string<EventOptionType>()
  .oneOf(Object.values(EventOptionType))
  .defined();
...
export function ComponentInputSchema(): yup.ObjectSchema<ComponentInput> {
  return yup.object({
    ...
    childrens: yup
      .array(yup.lazy(() => ComponentInputSchema()))
      .defined()
      .nullable()
      .optional(),
...
export function PageInputSchema(): yup.ObjectSchema<PageInput> {
  return yup.object({
    attributes: yup
      .array(yup.lazy(() => AttributeInputSchema().nonNullable()))
      .defined()
      .nullable()
      .optional(),
